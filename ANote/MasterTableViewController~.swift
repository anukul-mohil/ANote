...
//    }
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        resultSearchController.searchBar.setBackgroundImage(<#backgroundImage: UIImage?#>, forBarPosition: <#UIBarPosition#>, barMetrics: <#UIBarMetrics#>)
